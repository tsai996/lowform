...
<template>
  ...
  <el-form-item prop="minRows" label="最小行数" v-if="activeData?.props.autosize !== undefined">
    <el-input-number
      v-model="activeData.props.autosize.minRows"
      :max="activeData.props.autosize.maxRows"
      :style="{ width: '100%' }"
      :min="1"
      placeholder="最大行数"
  ...
  <el-form-item prop="minRows" label="最大行数" v-if="activeData?.props.autosize !== undefined">
    <el-input-number
      v-model="activeData.props.autosize.maxRows"
      :min="activeData.props.autosize.minRows"
      :style="{ width: '100%' }"
      placeholder="最大行数"
      @change="changeRenderKey"
    />
